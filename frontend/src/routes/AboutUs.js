...
export default function AboutUs() {
  ...
  return (
    <>
      ...
      <div
        style={{ backgroundImage: `url(${aboutUsImgUrls[idx]})` }}
      ...
      >
        <div style={{ color: aboutUsColor[idx] }} className={styles.msgInside}>
          ...
          <div className={styles.msgBestCommerce}>
            ...
            <div>
              Stillsteal dreams of evolving into the best commerce platform that
              provides everything related to shopping. As the gateway to
              shopping trusted by customers,
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.msgOutside}>
        <div>
          ...
          <h3>
            ...
            activities provide customers with a reliable shopping environment.
          </h3>
        </div>
        <div>
          <div>
          ...
          <h3>
            ...
            social contribution program shared with Stillsteal and
            sales/purchasing customers, create social value and create a better
            life together.
          </h3>
        </div>
        <div>
          ...
          <h3>
            ...
            technology and big data-based customized recommendation technology
            provide customers with a more convenient shopping experience.
          </h3>
        </div>
      </div>
      {/* Vision & Mission */}
      <div className={styles.visionMissionCEOContainer}>
        <div className={styles.visionMissionCeo}>
          <div className={styles.visionMission}>
            ...
            <div>
              <p>
                <b>The best commerce platform trusted by customers</b>
              </p>
              <br />
              <p>
                We dream of evolving into a shopping gateway that sells
                everything in the world. Stillsteal is where you can find all
                types of products and services that customers want.
              </p>
              <br />
              <p>
                We believe that our technology will enable us to provide optimal
                solutions to our customers in all aspects of their shopping
                journey, from browsing to purchasing. Stillsteal provides
                absolute convenience for shopping.
              </p>
              <br />
              <p>
                We are constantly striving for a wise shopping life for our
                customers. Stillsteal is a place that offers more fun and
                excitement than shopping with rich content.
              </p>
              <br />
              <p>
                Stillsteal, which provides satisfactory service to sales and
                purchase customers, and enhances the convenience of all. Our
                vision is to become a stepping stone to create a better
                tomorrow's shopping life than today's.
              </p>
              <br />
            </div>
          </div>
          ...
          <div className={styles.ceo}>
            ...
            <div>
              ...
              <p>and for visiting this website,</p>
              <br />
              <p>
                We ask for your encouragement and cooperation so that our
                platform can further develop in the future.
              </p>
              <br />
              <p>
                We will do our best to provide best service for you who shop
                with us.
              </p>
              <br />
            </div>
