                ...
                <nav aria-label="Page navigation example">
                    <ul className="inline-flex -space-x-px">
                        <button disabled={page === 1} onClick={() => { setPage(page - 1); window.scrollTo(0, 0); }}
                         ...
                         rounded-l-lg leading-tight py-2 px-3 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 
                                ...
                                .map((_, idx) => (    // extract only index
                                    <button
                                        className={page === idx + 1 ? (  // Current page = Blue, Others = Gray
                                            ...
                                            "bg-white border border-gray-300 text-gray-200 hover:bg-gray-100 hover:text-gray-700 leading-tight py-2 px-3 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                                        )}
                                        key={idx + 1}
                        ...
                        rounded-r-lg leading-tight py-2 px-3 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 
                        dark:hover:bg-gray-700 dark:hover:text-white">
                            &gt;
                        </button>
                    </ul>
